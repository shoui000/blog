...
if config_env() in [:dev, :prod] do
  ...
  db_pass = System.get_env("DB_PASSWORD") || raise "environment variable DB_PASSWORD is missing."
  ...
  config :blog, BlogWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/blog_web/router\.ex$"E,
        ~r"lib/blog_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
